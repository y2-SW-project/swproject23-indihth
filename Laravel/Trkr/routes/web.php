...
Route::get('/user/users/createProfile',[HomeController::class,'createProfile'])->name('home.createProfile');
...
Route::post('/user/users/addPartner',[UserUserController::class,'addPartner'])->name('user.users.addPartner');
